...
package com.platine.liveresto.rangeseekbar;
...
import com.platine.liveresto.util.BitmapUtil;
import com.platine.liveresto.util.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    public static final int HEIGHT_IN_DP = 70;
    ...
    public RangeSeekBar(Context context, String label) {
        super(context);
        this.label = label;
        init(context, null);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int thumbDisabled = R.drawable.seek_thumb_normal;
        ...
        if (attrs == null) {
            ...
            try {
                ...
                showTextAboveThumbs = true;
                textAboveThumbsColor = a.getColor(R.styleable.RangeSeekBar_textAboveThumbsColor, Color.BLACK);
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (showTextAboveThumbs && (activateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            String minText = valueToString(getSelectedMinValue())+label;
            String maxText = valueToString(getSelectedMaxValue())+label;
